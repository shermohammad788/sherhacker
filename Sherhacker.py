#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Shermohammad
...
In many cases (such as GMail) you can simply copy the above color faded text and paste it into your destination. If you cannot, copy and use the color code below.
  ...
  \033[1;91m:》》》\033[1;93m+923023517506\033[1;91m《《《▒▒▒▒▒▒▒▒▒▒▒:::::
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96m-SHER-\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;92m..........................Sher Mohammad......................
\033[1;93m╔╗ ╔╗╔═╦╦╦═╗ ╔╗╔╦═╦╦╗
\033[1;93m║║ ║╚╣║║║║╩╣ ╚╗╔╣║║║║   sher badshsh
\033[1;93m╚╝ ╚═╩═╩═╩═╝═ ╚╝╚═╩═╝ 
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96Sher Mohammad\033[1;95m♡╰──────────•◈•──────────╯♡"""
...
* ¸¸¸¸*__________________________* ¸¸¸¸*«┈┈┈┈┈┈┈┈┈         
 ...
 \033[1;96m ┈┈┈┈┈┈┈┈╱▔▔▔▔┊┊┊┊▔▔▔▔╲┈┈┈┈
  \033[1;96m ─────────────•◈•──────────  
   \033[1;92m███████▒▒Welcome To SHERhacker▒▒████████
\033[1;95m♡╭──────────•◈•──────────╮♡\033[1;96mSherHacker\033[1;95m♡╭──────────•◈•──────────╮♡
\033[1;94mAuthor\033[1;91m: \033[1;91SHERHhacker
\033[1;94mBlackMafia\033[1;91m: \033[1;91▒▓██████████████]100.%
\033[1;94mFacebook\033[1;91m: \033[1;91sherhacker
\033[1;94mWhatsapp\033[1;91m: \033[1;91m+923046327012
\033[1;95m♡╰──────────•◈•──────────╯♡\033[1;96mShermohammad\033[1;95m♡╰──────────•◈•──────────╯♡"""
jalan('              \033[1;96m....................Sher Mohammad.....................:')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╱▔▔▔▔╲┈┈┈┈┈┈┈┈   ")
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕╲┊┊╱▏▏┈┈┈┈┈┈┈   ')
jalan('\033[1;93m   ┈┈┈┈┈┈┈▕▕▂╱╲▂▏▏┈┈┈┈┈┈┈   ')
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈╲┊┊┊┊╱┈┈┈┈┈┈┈┈ ")
jalan("\033[1;93m   ┈┈┈┈┈┈┈┈▕╲▂▂╱▏┈┈┈┈┈┈┈┈")
print "\033[1;93m♡─────╱▔▔▔▔┊┊┊┊▔▔▔▔╲───────♡\033[1;96mLogin SherHacker\033[1;95m♡╰──────────•◈•──────────╯♡"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev: SHERhacker
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;
            os.system(https://youtu.be/KnujP8MnUAw')
    else:
...
def menu():
	os.system('clear')
	try:
		toket=open('withoutlogin.txt','r').read()
	except IOError:
		os.system('clear')
		print"\x1b[1;91mNo Token invalid"
		os.system('rm -rf without login.txt')
		time.sleep(1)
		without login()
	try:
		...
		os.system('clear')
		print"\033[1;91mYour Account is on successful"
		os.system('rm -rf without login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
		...
		keluar()
	os.system("clear") #Dev:Sher_hacker
	print logo
	...
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96Sher Mohammad\033[1;95m♡──────────•◈•──────────♡"
...
def super():
	...
	os.system('clear')
	try:
		toket=open('without login.txt','r').read()
	except IOError:
		print"\x1b[1;91NoToken invalid"
		os.system('rm -rf without login.txt')
		time.sleep(1)
		login()
	os.system('clear')
...
def pilih_super():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print "\033[1;95m♡──────────•◈•──────────♡\033[1;96mSher Mohammad\033[1;95m♡──────────•◈•──────────♡"
	print "  \033[1;93m«---•◈•---Developed By Sher Mohammad---•◈•---»" #Dev:Sher_hacker
